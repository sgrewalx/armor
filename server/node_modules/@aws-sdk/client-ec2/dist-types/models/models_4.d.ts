...
import { type AttributeValue, type ConnectionTrackingSpecificationRequest, type EnaSrdSpecificationRequest, type FleetLaunchTemplateSpecification, type InstanceRequirements, type NetworkInterfaceAttachment, type Placement, type SpotInstanceStateFault, type StateReason, BlockDeviceMapping, GroupIdentifier, InstanceIpv6Address, InternetGateway, Ipam, IpamExternalResourceVerificationToken, IpamPolicy, IpamPool, IpamPrefixListResolver, IpamPrefixListResolverTarget, IpamResourceDiscovery, IpamScope, Ipv4PrefixSpecificationRequest, Ipv6PrefixSpecificationRequest, LaunchTemplate, LaunchTemplateVersion, LocalGatewayRouteTable, LocalGatewayRouteTableVirtualInterfaceGroupAssociation, LocalGatewayRouteTableVpcAssociation, LocalGatewayVirtualInterface, LocalGatewayVirtualInterfaceGroup, ManagedPrefixList, NatGateway, NetworkAcl, NetworkInsightsAccessScope, NetworkInsightsPath, NetworkInterface, NetworkInterfacePermission, PlacementGroup, PrivateIpAddressSpecification, ReplaceRootVolumeTask, RouteServer, RouteServerEndpoint, RouteServerPeer, RouteTable, Snapshot } from "./models_1";
import { type SpotDatafeedSubscription, TrafficMirrorFilter, TrafficMirrorFilterRule, TrafficMirrorSession, TrafficMirrorTarget, TransitGateway, TransitGatewayConnect, TransitGatewayConnectPeer, TransitGatewayMeteringPolicy, TransitGatewayMulticastDomain, TransitGatewayPolicyTable, TransitGatewayRouteTable, TransitGatewayRouteTableAnnouncement, VerifiedAccessEndpoint, VerifiedAccessGroup } from "./models_2";
import { type AttributeBooleanValue, type CapacityReservationSpecificationResponse, type ConnectionTrackingSpecificationResponse, type CpuOptions, type EnclaveOptions, type EventInformation, type HibernationOptions, type InstanceMaintenanceOptions, type InstanceMetadataOptionsResponse, type InstanceNetworkInterfaceAssociation, type InstanceNetworkInterfaceAttachment, type InstanceState, type Monitoring, Byoasn, ElasticGpuAssociation, ElasticInferenceAcceleratorAssociation, Filter, IdFormat, InstanceBlockDeviceMapping, InstanceIpv4Prefix, LicenseConfiguration, ProductCode } from "./models_3";
/**
